...
class seatMatrix
{
	int[][] seat = new int[2][2];	// to store the seat matrix for each train
...
// class to represent the hard coded passengers details
class Register
{
	//	String fName,lName;
	//	int Reg_no;
	...
	void register(seatMatrix getSeat)
	{
		passNode REhead =  new passNode();
		...
		while(REhead != null)
		{
			...
			REhead.age = 19;
			REhead.gender = "F";
			REhead.train_class = "3rd AC";
			REhead.date = "12/12/2023";
			REhead.seatNo = 11;
			getSeat.set.remove(REhead.seatNo);
			REhead = REhead.next;
			
			REhead.fName = "Shruti";
			REhead.lName = "Chandak";
			REhead.age = 19;
			REhead.gender = "F";
			REhead.train_class = "3rd AC";
			REhead.date = "12/02/2023";
			REhead.seatNo = 12;
			getSeat.set.remove(REhead.seatNo);
			REhead.next = null;		// Indicating the end of the linked list 
		}
	}
}
